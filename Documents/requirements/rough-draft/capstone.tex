...
\begin{ganttchart}[hgrid, vgrid]{1}{15}
    ...
    \ganttbar{Interactive Circle of Fifths: 00}{6}{13} \\
    \ganttbar{Composition Page: 01}{6}{13} \\
    \ganttbar{Reference and Tutorial Pages: 02}{6}{13} \\

    \ganttbar{Add Stretch Features and finishing touches}{8}{13} \\
    \ganttbar{QA Testing}{8}{13} \\
