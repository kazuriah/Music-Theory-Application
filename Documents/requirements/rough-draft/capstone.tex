...
\begin{ganttchart}[hgrid, vgrid]{1}{15}
    \gantttitle{Fall 2017}{5}
    \gantttitle{Winter 2018}{5}
    \gantttitle{Spring 2018}{5} \\

    \ganttbar{Problem statement}{1.5}{2} \\
    \ganttbar{Requirements}{2.5}{3} \\

    \ganttbar{Interactive Circle of Fifths}{3}{6} \\
    \ganttbar{Circle of Fifths Sidebar: 01; Depends on 00}{6}{8} \\
    \ganttbar{Parallel and Relative Keys: 02; Depends on 00}{6}{8} \\
    \ganttbar{Composition Page: 03}{3}{8} \\
    \ganttbar{Reference and Tutorial Pages: 04}{3}{8} \\

    \ganttbar{Add Stretch Features and finishing touches}{5.5}{13} \\
    \ganttbar{QA Testing}{5.5}{13} \\
    \ganttbar{Finalize Project}{13}{14} \\
